...
try:
    ...
    plt.gcf().text(
        ...
        "Figure 1: Average Percentage Contribution of Each Food Group to the Global Cost of a Healthy Diet (2021 USD). "
    ...
    print("Pie chart with caption saved to './figures/pie_chart_cost_contributions.png'")
